...
def get_recommendations_by_items_clicked(items_clicked, similarity_matrix, data, top_n=5):
...
recommended_listings = get_recommendations_by_items_clicked(listing_ids, cosine_similarity_matrix, data)
